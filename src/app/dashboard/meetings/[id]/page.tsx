...
export default function MeetingDetailsPage() {
  ...
  const loadMeetingData = async () => {
    try {
      ...
      // Load meeting, resolutions, and actionables in parallel
      const [meetingRes, resolutionsRes, actionablesRes] = await Promise.all([
        fetch(`/api/meetings/${meetingId}`),
        fetch(`/api/meetings/${meetingId}/resolutions`),
        fetch(`/api/meetings/${meetingId}/actionables`)
      ]);

...
-- =====================================================
-- 1. AUTH USERS & USERS (Create auth users first, then public users)
-- =====================================================

-- First create auth users (these would normally be created by Supabase Auth)
-- Note: This requires service_role permissions to insert into auth.users
...
-- TechFlow Innovations Auth Users
('00000000-0000-0000-0000-000000000000', '11111111-1111-1111-1111-111111111111', 'authenticated', 'authenticated', 'ceo@techflow.com', crypt('password123', gen_salt('bf')), NOW() - INTERVAL '30 days', NULL, NOW() - INTERVAL '1 day', '{"provider":"email","providers":["email"]}', '{}', NOW() - INTERVAL '30 days', NOW(), '', '', '', ''),
('00000000-0000-0000-0000-000000000000', '11111111-1111-1111-1111-111111111112', 'authenticated', 'authenticated', 'cto@techflow.com', crypt('password123', gen_salt('bf')), NOW() - INTERVAL '28 days', NULL, NOW() - INTERVAL '2 days', '{"provider":"email","providers":["email"]}', '{}', NOW() - INTERVAL '28 days', NOW(), '', '', '', ''),
('00000000-0000-0000-0000-000000000000', '11111111-1111-1111-1111-111111111113', 'authenticated', 'authenticated', 'cfo@techflow.com', crypt('password123', gen_salt('bf')), NOW() - INTERVAL '25 days', NULL, NOW() - INTERVAL '3 days', '{"provider":"email","providers":["email"]}', '{}', NOW() - INTERVAL '25 days', NOW(), '', '', '', ''),
('00000000-0000-0000-0000-000000000000', '11111111-1111-1111-1111-111111111114', 'authenticated', 'authenticated', 'legal@techflow.com', crypt('password123', gen_salt('bf')), NOW() - INTERVAL '22 days', NULL, NOW() - INTERVAL '4 days', '{"provider":"email","providers":["email"]}', '{}', NOW() - INTERVAL '22 days', NOW(), '', '', '', ''),

-- FinTech Solutions Auth Users  
('00000000-0000-0000-0000-000000000000', '22222222-2222-2222-2222-222222222222', 'authenticated', 'authenticated', 'ceo@fintech.com', crypt('password123', gen_salt('bf')), NOW() - INTERVAL '35 days', NULL, NOW() - INTERVAL '1 day', '{"provider":"email","providers":["email"]}', '{}', NOW() - INTERVAL '35 days', NOW(), '', '', '', ''),
('00000000-0000-0000-0000-000000000000', '22222222-2222-2222-2222-222222222223', 'authenticated', 'authenticated', 'coo@fintech.com', crypt('password123', gen_salt('bf')), NOW() - INTERVAL '32 days', NULL, NOW() - INTERVAL '2 days', '{"provider":"email","providers":["email"]}', '{}', NOW() - INTERVAL '32 days', NOW(), '', '', '', ''),
('00000000-0000-0000-0000-000000000000', '22222222-2222-2222-2222-222222222224', 'authenticated', 'authenticated', 'cro@fintech.com', crypt('password123', gen_salt('bf')), NOW() - INTERVAL '30 days', NULL, NOW() - INTERVAL '3 days', '{"provider":"email","providers":["email"]}', '{}', NOW() - INTERVAL '30 days', NOW(), '', '', '', ''),
('00000000-0000-0000-0000-000000000000', '22222222-2222-2222-2222-222222222225', 'authenticated', 'authenticated', 'compliance@fintech.com', crypt('password123', gen_salt('bf')), NOW() - INTERVAL '27 days', NULL, NOW() - INTERVAL '4 days', '{"provider":"email","providers":["email"]}', '{}', NOW() - INTERVAL '27 days', NOW(), '', '', '', ''),

-- MedCare Health Auth Users
('00000000-0000-0000-0000-000000000000', '33333333-3333-3333-3333-333333333333', 'authenticated', 'authenticated', 'ceo@medcare.com', crypt('password123', gen_salt('bf')), NOW() - INTERVAL '40 days', NULL, NOW() - INTERVAL '1 day', '{"provider":"email","providers":["email"]}', '{}', NOW() - INTERVAL '40 days', NOW(), '', '', '', ''),
('00000000-0000-0000-0000-000000000000', '33333333-3333-3333-3333-333333333334', 'authenticated', 'authenticated', 'cmo@medcare.com', crypt('password123', gen_salt('bf')), NOW() - INTERVAL '38 days', NULL, NOW() - INTERVAL '2 days', '{"provider":"email","providers":["email"]}', '{}', NOW() - INTERVAL '38 days', NOW(), '', '', '', ''),
('00000000-0000-0000-0000-000000000000', '33333333-3333-3333-3333-333333333335', 'authenticated', 'authenticated', 'cfo@medcare.com', crypt('password123', gen_salt('bf')), NOW() - INTERVAL '35 days', NULL, NOW() - INTERVAL '3 days', '{"provider":"email","providers":["email"]}', '{}', NOW() - INTERVAL '35 days', NOW(), '', '', '', ''),
('00000000-0000-0000-0000-000000000000', '33333333-3333-3333-3333-333333333336', 'authenticated', 'authenticated', 'quality@medcare.com', crypt('password123', gen_salt('bf')), NOW() - INTERVAL '33 days', NULL, NOW() - INTERVAL '4 days', '{"provider":"email","providers":["email"]}', '{}', NOW() - INTERVAL '33 days', NOW(), '', '', '', ''),

-- Industrial Corp Auth Users
('00000000-0000-0000-0000-000000000000', '44444444-4444-4444-4444-444444444444', 'authenticated', 'authenticated', 'ceo@industrial.com', crypt('password123', gen_salt('bf')), NOW() - INTERVAL '45 days', NULL, NOW() - INTERVAL '1 day', '{"provider":"email","providers":["email"]}', '{}', NOW() - INTERVAL '45 days', NOW(), '', '', '', ''),
('00000000-0000-0000-0000-000000000000', '44444444-4444-4444-4444-444444444445', 'authenticated', 'authenticated', 'coo@industrial.com', crypt('password123', gen_salt('bf')), NOW() - INTERVAL '42 days', NULL, NOW() - INTERVAL '2 days', '{"provider":"email","providers":["email"]}', '{}', NOW() - INTERVAL '42 days', NOW(), '', '', '', ''),
('00000000-0000-0000-0000-000000000000', '44444444-4444-4444-4444-444444444446', 'authenticated', 'authenticated', 'cto@industrial.com', crypt('password123', gen_salt('bf')), NOW() - INTERVAL '40 days', NULL, NOW() - INTERVAL '3 days', '{"provider":"email","providers":["email"]}', '{}', NOW() - INTERVAL '40 days', NOW(), '', '', '', ''),
('00000000-0000-0000-0000-000000000000', '44444444-4444-4444-4444-444444444447', 'authenticated', 'authenticated', 'safety@industrial.com', crypt('password123', gen_salt('bf')), NOW() - INTERVAL '38 days', NULL, NOW() - INTERVAL '4 days', '{"provider":"email","providers":["email"]}', '{}', NOW() - INTERVAL '38 days', NOW(), '', '', '', '');

-- Now create public users (these reference the auth users above)
...
-- FinTech Solutions Users  
('22222222-2222-2222-2222-222222222222', 'ceo@fintech.com', 'Jennifer Adams', 'admin', 'approved', NOW() - INTERVAL '35 days', NOW(), 'https://api.dicebear.com/7.x/avataaars/svg?seed=jennifer', 'FinTech Global Corp', 'Chief Executive Officer'),
('22222222-2222-2222-2222-222222222223', 'coo@fintech.com', 'Robert Kim', 'director', 'approved', NOW() - INTERVAL '32 days', NOW(), 'https://api.dicebear.com/7.x/avataaars/svg?seed=robert', 'FinTech Global Corp', 'Chief Operations Officer'),
('22222222-2222-2222-2222-222222222224', 'cro@fintech.com', 'Maria Santos', 'director', 'approved', NOW() - INTERVAL '30 days', NOW(), 'https://api.dicebear.com/7.x/avataaars/svg?seed=maria', 'FinTech Global Corp', 'Chief Risk Officer'),
('22222222-2222-2222-2222-222222222225', 'compliance@fintech.com', 'Ahmed Hassan', 'viewer', 'approved', NOW() - INTERVAL '27 days', NOW(), 'https://api.dicebear.com/7.x/avataaars/svg?seed=ahmed', 'FinTech Global Corp', 'Compliance Director'),

-- MedCare Health Users
('33333333-3333-3333-3333-333333333333', 'ceo@medcare.com', 'Dr. Emily Watson', 'admin', 'approved', NOW() - INTERVAL '40 days', NOW(), 'https://api.dicebear.com/7.x/avataaars/svg?seed=emily', 'MedCare Health Systems', 'Chief Executive Officer'),
('33333333-3333-3333-3333-333333333334', 'cmo@medcare.com', 'Dr. James Mitchell', 'director', 'approved', NOW() - INTERVAL '38 days', NOW(), 'https://api.dicebear.com/7.x/avataaars/svg?seed=james', 'MedCare Health Systems', 'Chief Medical Officer'),
('33333333-3333-3333-3333-333333333335', 'cfo@medcare.com', 'Rachel Thompson', 'director', 'approved', NOW() - INTERVAL '35 days', NOW(), 'https://api.dicebear.com/7.x/avataaars/svg?seed=rachel', 'MedCare Health Systems', 'Chief Financial Officer'),
('33333333-3333-3333-3333-333333333336', 'quality@medcare.com', 'Dr. Michael Chang', 'viewer', 'approved', NOW() - INTERVAL '33 days', NOW(), 'https://api.dicebear.com/7.x/avataaars/svg?seed=michael', 'MedCare Health Systems', 'Quality Assurance Director'),

-- Industrial Corp Users
('44444444-4444-4444-4444-444444444444', 'ceo@industrial.com', 'William Foster', 'admin', 'approved', NOW() - INTERVAL '45 days', NOW(), 'https://api.dicebear.com/7.x/avataaars/svg?seed=william', 'Industrial Dynamics Ltd', 'Chief Executive Officer'),
('44444444-4444-4444-4444-444444444445', 'coo@industrial.com', 'Angela Martinez', 'director', 'approved', NOW() - INTERVAL '42 days', NOW(), 'https://api.dicebear.com/7.x/avataaars/svg?seed=angela', 'Industrial Dynamics Ltd', 'Chief Operations Officer'),
('44444444-4444-4444-4444-444444444446', 'cto@industrial.com', 'Thomas Lee', 'director', 'approved', NOW() - INTERVAL '40 days', NOW(), 'https://api.dicebear.com/7.x/avataaars/svg?seed=thomas', 'Industrial Dynamics Ltd', 'Chief Technology Officer'),
('44444444-4444-4444-4444-444444444447', 'safety@industrial.com', 'Priya Patel', 'viewer', 'approved', NOW() - INTERVAL '38 days', NOW(), 'https://api.dicebear.com/7.x/avataaars/svg?seed=priya', 'Industrial Dynamics Ltd', 'Safety Director');

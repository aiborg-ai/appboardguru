-- Standalone Calendar Migration - No Dependencies
...
BEGIN
  ...
  IF test_user_id IS NOT NULL THEN
    ...
    (event_id, test_user_id, 'test.director@boardguru.ai', 'organizer');
    
    -- Add reminders for the first event  
    INSERT INTO calendar_reminders (event_id, user_id, reminder_type, minutes_before) VALUES
    (event_id, test_user_id, 'email', 1440), -- 24 hours before
    (event_id, test_user_id, 'in_app', 60);  -- 1 hour before
